    ...
    return (
        <ul className={ styles.list }>
            <li>
                ...
                Com base nas informações e documentos que você nos conceder, desenvolveremos o plano de pagamento de acordo com as suas possibilidades, sem apertos no final do mês e sem deixar de pagar o principal.
                </Subtitle>
            </li>
            <li>
                <div className={ styles.path}>
                ...
                <Subtitle size={true} left={true}>
                Extrajudicialmente, notificaremos todos os credores para que se adaptem a nova lei. Com isso muitos credores já reduzirão os valores
                </Subtitle>
            </li>
            <li>
                <div className={ styles.path}>
            ...
            <li>
                ...
                <Subtitle size={true} left={true}>
                O juiz designará audiência, com maior brevidade possível, onde todos comparecem de forma online, argumentam suas razões e procuram um consenso.
                </Subtitle>
                <Subtitle size={true} left={true}>
                O credor que não comparecer, fica para o final da fila!
                </Subtitle>
            </li>
            <li>
                <div className={ styles.path}>
