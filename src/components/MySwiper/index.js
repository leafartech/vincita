            ...
            <div>
                ...
                >
                    <SwiperSlide className="swiper-slide">
                        <Card imagePath="2" title="Ressarcimento de RMC:">
                            <p>Analisamos as operações de RMC para verificar ilegalidades e levantar valores cobrados de forma indevida.</p>
                        </Card>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                    ...
                    <SwiperSlide className="swiper-slide">
                        <Card imagePath="1" title="Golpe da portabilidade:">
                            <p>Muitas vezes na tentativa de diminuir as dívidas o consumidor acaba fazendo a portabilidade bancária. Com falsas promessas de que os valores a ser pagas irão diminuir, assinam contratos que não condizem com o produto oferecido.</p>
                        </Card>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
