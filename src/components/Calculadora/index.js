    ...
    return (
        <div className={ `${styles.calculadora}`} id="calculadora">
            ...
            <form className={ styles.forms }>
                <Subtitle bg={true}>No simples cálculo abaixo você saberá qual sua situação financeira:</Subtitle>
                ...
                <div className={ styles.progressDiv}>
                    ...
                    <span onClick={e => calculate(e)} style={{ color: 'var(--secodary-color)', textDecoration: 'underline', fontWeight: 'bold', cursor: 'pointer'}}>Clique para calcular nível de indicação</span>
                </div>
                <Button path="/#formulario" link={true} alert={ animation ? true : false}>Recupere a sua estabilidade financeira agora!</Button>
                <div className={ styles.bottom } style={{ marginTop: '24px'}}>
