            ...
            <Main>
                ...
                <Section top={true}>
                    ...
                    <div className={ styles.text }>
                        <Subtitle justify={true}>Nós somos o escritório de advocacia Krüger Toledo especializado em resolver o problema do superendividamento dos servidores públicos.</Subtitle>
                        <Subtitle justify={true}>Com nossa vasta experiência no atendimento de mais de 350 clientes e gerenciamento de mais de 13 milhões de reais, estamos plenamente capacitados a desenvolver estratégias jurídicas altamente eficazes para reequilibrar as finanças pessoais dos servidores públicos em um tempo recorde.</Subtitle>
                        <Subtitle justify={true}>O escritório conta com uma equipe formada por:</Subtitle>
