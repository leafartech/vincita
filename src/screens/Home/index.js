        ...
        <Template>
            ...
            <main className={ styles.main }>
                ...
                <Section bg={true} top={true}>
                    ...
                    <img src="./images/map2.png" alt="Localização do escritório Krüger Toledo" className={ styles.map } style={{ marginTop: '24px'}}/>
                    <span style={{ marginTop: '24px'}}><Subtitle left={true}>São Paulo/SP   Avenida Paulista, 1471, conjunto 511, Bela Vista</Subtitle></span>
