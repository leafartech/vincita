...
export default function HomeScreen() {
    ...
    useEffect(() => {
        if (cont === 0) {
            ...
            script.onload = () => {
              new RDStationForms('01-lrd-689e502f9374a4e15a9c', 'null').createForm();
            };
    ...
    return (
        <Template>
            <div className={ styles.logoDiv }>
                <img className={ styles.logo } src="./images/logo.png" alt="Escritório de advocacia Krüger Toledo" />
            </div>
            ...
            <main className={ styles.main }>
                ...
                <Section >
                    ...
                    <div className={ styles.about }>
                        ...
                        <div className={ styles.text }>
                            ...
                            <Subtitle justify={true}>
                                Com nossa vasta experiência de gerenciamento de mais de 13 milhões reais, estamos plenamente capacitados a desenvolver estratégias jurídicas altamente eficazes para reequilibrar as finanças pessoais dos servidores públicos em um tempo recorde.
                            </Subtitle>
                        </div>
                ...
                <Section bg={true} top={true}>
                    ...
                    <img src="./images/map.png" alt="Localização do escritório Krüger Toledo" className={ styles.map } style={{ marginTop: '24px'}}/>
                ...
                <div className={ styles.formulario } id="formulario">
                    ...
                    <img src="./images/logo.png" alt="Escritório de advocacia Krüger Toledo" />
                </div>
            </main>
        </Template>
    )
