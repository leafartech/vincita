            ...
            <main className={ styles.main }>
                ...
                <Section >
                    ...
                    <div className={ styles.about }>
                        ...
                        <div className={ styles.text }>
                            <Subtitle justify={true}>
                                Nós somos o escritório de advocacia Kruger Toledo especializado em resolver o problema do superendividamento dos servidores públicos.
                            </Subtitle>
                            <Subtitle justify={true}>
                ...
                <div className={ styles.formulario } id="formulario">
                    ...
                    <img src="./images/logo.png" alt="Escritório de advocacia Kruger Toledo" />
                </div>
            </main>
        </Template>
    )
