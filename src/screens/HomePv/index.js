...
export default function HomeScreen() {
    ...
    return (
        <Template>
            ...
            <Header text="Reduza Suas Dívidas em Até 70% com a Lei de Repactuação!">
                <Subtitle>
                Cansado de lutar contra suas dívidas? Assista ao nosso vídeo para descobrir como a Lei de Repactuação pode ajudá-lo a pagar suas dívidas por um valor muito menor. Não permita que os descontos mensais em sua conta corrente continuem prejudicando suas finanças. Assista ao vídeo agora e entenda como você pode pagar suas dívidas de forma mais acessível com a Lei de Repactuação.
                </Subtitle>
