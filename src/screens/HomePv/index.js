...
export default function HomeScreen() {
    ...
    useEffect(() => {
        if (cont === 0) {
          ...
          script.onload = () => {
            new RDStationForms('01-lrd-duplicado-83f11736556d620d9ffe', 'null').createForm();
          };
        ...
        <Template>
            ...
            <main className={ styles.main }>
                ...
                <div className={ styles.formulario } id="formulario">
                    <div role="main" id="01-lrd-duplicado-83f11736556d620d9ffe"></div>
