        ...
        <Template>
            ...
            <Header text="Diminua sua dívida e Recupere sua Estabilidade Financeira">
                ...
                <div className={ styles.video }>
                    ...
                    <img style={{ marginTop: '18px' }} src="./imagesPv/videoMock.png" alt="Vídeo do header" />
                </div>
            ...
            <main className={ styles.main }>
                ...
                <Section >
                    <img src="./imagesPv/img.png" alt="Imagem icônica de direito" className={ styles.lastImg }/>
