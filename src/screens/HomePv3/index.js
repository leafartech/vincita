...
export default function HomeScreen() {
    ...
    return (
        <Template>
            ...
            <Header text="Pagamento Mais Baixo para Servidores públicos! Dê um fim às parcelas altíssimas.">
                <Subtitle>
                Está na hora de aliviar o peso das suas dívidas? Se suas parcelas estão prejudicando seu orçamento, temos a solução. Assista ao nosso vídeo e descubra como a Lei de Repactuação de Dívidas pode ajudá-lo a pagar suas dívidas por um valor mais baixo. Não deixe seu salário ser dominado por dívidas. Assista ao nosso vídeo revelador e dê o primeiro passo rumo a pagamentos mais acessíveis e alívio financeiro.
                </Subtitle>
