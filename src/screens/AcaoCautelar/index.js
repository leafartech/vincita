    ...
    return (
        <Template>
            ...
            <Header text="Recupere os valores indevidamentes cobrados do seu salário">
                <Subtitle>
                    Através da ação cautelar, o banco pode parar de “comer” o seu salário!
                </Subtitle>
            ...
            <main className={styles.main}>
                <Section>
                    ...
                    <Text bottom={false} tag="h2">Um pedido de socorro legal enquanto o seu processo não anda!</Text>
                ...
                <Section bg={true}>
                    <div className={`${styles.bottom} ${styles.size}`}>
                    ...
                    <div className={`${styles.top} ${styles.size}`}>
