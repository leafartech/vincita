    ...
    return (
        <Template>
            ...
            <Header text="Vítima do golpe da falsa portabilidade? Entenda como pode solucionar o seu caso!">
                <Subtitle>
                    Este golpe tem crescido absurdamente por meio da  fraudulenta/mentirosa de <strong>reduzir as parcelas de empréstimos consignados</strong>. Se você foi vítima desta fraude, saiba que seu caso tem solução! <strong>Pare imediatamente de minar suas finanças</strong> e pare de se preocupar com isso de uma vez por todas!
                </Subtitle>
                ...
                <Section>
                    ...
                    <div className={styles.check_div}>
                        <Subtitle>Você possui um empréstimo consignado com algum banco.</Subtitle>
                        <Subtitle>Um dia, alguém entra em contato com você oferecendo a seguinte oferta: redução dos juros e redução do valor das parcelas mensais.</Subtitle>
                        <Subtitle>Tudo que você precisa fazer para garantir essa redução é fornecer alguns dados e aceitar a portabilidade para um novo banco do seu empréstimo consignado.</Subtitle>
                        <Subtitle>Então, você, interessado na proposta, fornece os dados e aceita a portabilidade.</Subtitle>
                        <Subtitle>Depois de um tempo, no entanto, você percebe que o seu primeiro empréstimo não foi quitado e que agora você possui mais um empréstimo.</Subtitle>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.formulario} id="formulario">
                    <div className={`${"_form_X"}  ${styles.border}`}></div>
                </div>
            </main>
            <Footer />
        </Template>
